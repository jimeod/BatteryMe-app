<template>
  <div
    ...
    @click="activity.done ? $emit('uncomplete') : $emit('open')"
  >
...
.act-card.done:hover {
  border-color: #e06b6b;
  background: rgba(224, 107, 107, 0.05);
  transform: translateY(-1px);
  box-shadow: 0 4px 16px rgba(224, 107, 107, 0.1);
}
